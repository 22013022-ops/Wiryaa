...
const findJobsProfileSchema = new mongoose.Schema({
  ...
  stateEnglish: { type: String, trim: true, maxlength: 100 },
  city: { type: String, trim: true, maxlength: 100 },
  cityEnglish: { type: String, trim: true, maxlength: 100 },
  pincode: { type: String, trim: true, match: /^$|^[0-9]{6}$/ },
  qualification: { type: String, trim: true, maxlength: 250 },
  qualificationEnglish: { type: String, trim: true, maxlength: 250 },
  portfolio: { type: String, trim: true, maxlength: 500 },
  skills: { type: String, trim: true, maxlength: 3000 },
  skillsEnglish: { type: String, trim: true, maxlength: 3000 },
  skillsStructured: [{ skill_name: { type: String, required: true, trim: true, maxlength: 250 } }],
  ...
  preferencesEnglish: { type: String, trim: true, maxlength: 3000 },
  constraintsStructured: [{ constraint_text: { type: String, required: true, trim: true, maxlength: 1000 } }],
