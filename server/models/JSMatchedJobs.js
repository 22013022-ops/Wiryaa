...
const scoreSchema = new mongoose.Schema({
  job: { type: mongoose.Schema.Types.ObjectId, ref: 'HireTalentsJobPost', required: true },
...
const schema = new mongoose.Schema({
  ...
  jobs: { type: [scoreSchema], default: [] },
}, { collection: 'JS_matched_jobs', timestamps: true })

module.exports = mongoose.model('JSMatchedJobs', schema)
