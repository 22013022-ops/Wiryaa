...
const upload = multer({ storage: multer.memoryStorage(), fileFilter, limits: { fileSize: 10 * 1024 * 1024, files: 12 } })
const uploadFindJobsFiles = upload.fields([{ name: 'profilePicture', maxCount: 1 }, { name: 'resume', maxCount: 1 }, { name: 'workSamples', maxCount: 5 }, { name: 'certificationAttachments', maxCount: 5 }])
