...
function CreateProfile({ profile, loadingProfile, onSaved }) {
  const { t } = useTranslation(); const [submitted, setSubmitted] = useState(false); const [error, setError] = useState(''); const [submitting, setSubmitting] = useState(false); const [profilePicturePreview, setProfilePicturePreview] = useState(null); const formRef = useRef(null); const profilePictureInputRef = useRef(null)
  ...
  return <form ref={formRef} className="fj-form" onSubmit={handleSubmit} onChange={markUnsaved} encType="multipart/form-data">
